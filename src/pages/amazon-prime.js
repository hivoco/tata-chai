...
//   return (
//     <div className="flex flex-col h-svh bg-black text-white p-3">
//       {/* Top Navigation Bar */}
...
//       {/* Centered Voice Assistant Button */}
//       <div className=" backdrop-blur-sm  border-gray-800 h-full flex justify-center items-center flex-col gap-10">
//         <div className=" flex flex-col  items-center">
//           <button
//             onClick={toggleListening}
//             disabled={isLoading}
//             className={`relative w-16 h-16 flex items-center justify-center rounded-full shadow-lg transition-all duration-300 ${
//               isListening
...
//         {(transcript || response || isListening || isLoading || isPlaying) && (
//           <div className="bg-gray-900 bg-opacity-95 p-4 max-w-5xl  ">
...
//               {transcript && (
//                 <div className="mb-2 p-3 bg-gray-800 rounded-lg text-gray-200 text-sm">
//                   <p>You: {transcript}</p>
//                 </div>
//               )}

//               {response && (
//                 <div className="p-3 bg-blue-900 bg-opacity-40 rounded-lg text-blue-100 text-sm">
