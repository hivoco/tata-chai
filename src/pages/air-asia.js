...
const AirAsiaVoiceAssistant = () => {
  ...
  return (
    ...
    >
      {/* Top Navigation Bar */}
      <nav className="relative z-10 p-4 flex items-center justify-between  rounded-lg m-2">
        <div className="flex items-center space-x-6">
          <div className="flex items-center space-x-3">
            <PlaneIcon className="h-8 w-8 text-white drop-shadow-lg" />
            <div>
              <h1 className="text-2xl font-bold text-white drop-shadow-lg">
                AirAsia
              </h1>
              <p className="text-sm font-medium text-green-200 drop-shadow-md">
                Fly with Fufa Ji
              </p>
            </div>
          </div>
          <div className="hidden md:flex space-x-6">
            <a
              href="#"
              className="hover:text-green-200 text-white/90 font-medium transition-colors"
            >
              Book
            </a>
            <a
        ...
        <div
          ...
          style={{ backgroundColor: "rgba(220, 50, 36, 0.9)" }}
        >
          <span>F</span>
        </div>
      </nav>
        ...
        <div className="flex flex-col items-center relative -top-24">
          ...
          <div className="relative">
            ...
            >
              {isListening ? (
                ...
                <MicrophoneIcon className="h-10 w-10 text-green-500" />
              )}
          ...
          >
            ...
            {!isListening &&
              ...
              !transcript &&
              !response && (
                <p className="text-xs mt-1 opacity-90 text-white drop-shadow-md">
                  Ask me about flights or travel plans!
                </p>
              )}
          </div>
